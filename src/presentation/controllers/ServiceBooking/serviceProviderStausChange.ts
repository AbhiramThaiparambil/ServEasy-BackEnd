...
//     if (action === "accept") {
//       const { estimatedServiceTime, serviceStatus, reschedule, reschedReason } =
//         req.body;
...
//         res
//           .status(HttpStatus.BAD_REQUEST)
//           .json({ error: "Bad Request: Missing serviceStatus" });
//         return;
//       }
...
//       updatedService = await changeStatusContainer.requestPayment(
//         id,
//         payment,
//         paymentStatus
//       );
