...
serviceProviderSubscriptionRouter.get('/ai-assistance/chats/:chatId', (req, res) =>
...
serviceProviderSubscriptionRouter.get(
  ...
  (req, res) => serviceProviderSubscriptionController.getServiceProviderChatsHandler(req, res)
);
