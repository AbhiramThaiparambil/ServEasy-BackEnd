...
paymentRouter.post("/subscription/verify",authMiddleware('User'), serviceProviderAuth, (req, res)  => {
  paymentController.subscriptionVerifyPayment(req, res);
}); 

paymentRouter.post('/subscription/createOrder',authMiddleware('User'), serviceProviderAuth, (req, res) => {
