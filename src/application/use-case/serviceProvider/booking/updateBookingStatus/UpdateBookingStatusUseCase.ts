...
//     if (isConflicting) {
//       return {
//         error: "You have already allocated this time slot to a service.",
//       };
//     }
...
//         bookedServiceId,
//         "rescheduled",
//         `Your booking has been rescheduled to ${formatDateTime(
//           estimatedServiceTime
...
//         return {
//           error: "You have already confirmed this booking.please reload page",
//         };
//       }
...
//       bookedServiceId,
//       "cancelled",
//       "booking has been cancelled by service provider. Reason: " +
//         cancellationReason
//     );
