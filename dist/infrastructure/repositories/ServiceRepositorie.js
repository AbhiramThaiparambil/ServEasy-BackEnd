...
let ServiceRepository = class ServiceRepository {
    ...
    updateService(id, newData) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                return yield ServiceModel_1.default.findOneAndReplace({ _id: id }, newData, {
                    new: true,
                });
            }
            catch (error) {
    ...
    //   ]);
    //   }
    findAllActiveServicesUser(skip, limit) {
        return __awaiter(this, void 0, void 0, function* () {
            const pipeline = [
                {
                    $match: {
    ...
    //   return { services, nextCursor };
    // }
    findNearestServicesFilter(userId, skip, limit, userLongitude, userLatitude, filters) {
        return __awaiter(this, void 0, void 0, function* () {
            const maxDistanceInMeters = 20000;
            const pipeline = [];
            const categoryObjectId = (filters === null || filters === void 0 ? void 0 : filters.category) && mongoose_1.Types.ObjectId.isValid(filters.category)
                ? new mongoose_1.Types.ObjectId(filters.category)
                : null;
            let sortStage = { _id: 1 };
            ...
            pipeline.push({
                $lookup: {
                    from: "users",
                    let: { currentUserId: new mongoose_1.Types.ObjectId(userId) },
                    pipeline: [
    ...
    blockAllserviceServiceProvider(serviceProviderId) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const result = yield ServiceModel_1.default.updateMany({ serviceProviderId }, { $set: { isActive: false } });
                return result.modifiedCount > 0;
            }
            catch (error) {
    ...
    activateAllServicesByServiceProvider(serviceProviderId) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const result = yield ServiceModel_1.default.updateMany({ serviceProviderId }, { $set: { isActive: true } });
                return result.modifiedCount > 0;
            }
            catch (error) {
    ...
    findSingleOnlineServicesWithSlot(serviceId) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield ServiceModel_1.default.aggregate([
                {
                    $match: {
