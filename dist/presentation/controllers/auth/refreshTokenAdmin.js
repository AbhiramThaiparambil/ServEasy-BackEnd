...
exports.refreshTokenAdmin = void 0;
...
const refreshTokenAdmin = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const user = yield userRepo.findById(decoded.adminId);
        if (!user || !user.isAdmin) {
            res.status(404).json({ error: "user no found" });
            return;
        }
        const newAccessToken = yield tokenService.generateAccessToken(user._id + "", "adminId");
