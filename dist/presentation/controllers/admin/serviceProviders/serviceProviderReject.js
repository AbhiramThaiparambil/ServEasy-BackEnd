...
exports.serviceProviderReject = void 0;
...
const serviceProviderReject = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const data = yield serviceProvider.rejectServiceProvider(serviceProviderId, reason);
        if (data) {
...
exports.serviceProviderReject = serviceProviderReject;
