...
exports.getServiceDetailsServiceProvider = void 0;
const tsyringe_1 = require("tsyringe");
const mongoose_1 = __importDefault(require("mongoose"));
const GetBookedServiceById_1 = require("../../../application/use-case/bookService/GetBookedServiceById");
const HttpStatus_1 = require("../../../constants/HttpStatus");
const getServiceDetailsServiceProvider = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { id } = req.params;
        ...
        const service = yield bookService.ServiceProviderBookedService(new mongoose_1.default.Types.ObjectId(id));
...
exports.getServiceDetailsServiceProvider = getServiceDetailsServiceProvider;
