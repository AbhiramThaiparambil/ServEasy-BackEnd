...
class ChatHandler {
    ...
    register(socket) {
        ...
        socket.on("send_message", (_a) => __awaiter(this, [_a], void 0, function* ({ senderId, receiverId, message, senderInfo, targetRole, content }) {
            console.log(senderId, receiverId, message, senderInfo, targetRole, content);
            ...
            const savedMessage = yield this.saveMessageUseCase.execute(dto);
