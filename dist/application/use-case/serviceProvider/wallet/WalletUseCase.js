...
let WalletUseCase = class WalletUseCase {
    ...
    addTransactionToProviderWallet(providerId, transaction) {
        return __awaiter(this, void 0, void 0, function* () {
            let wallet = yield this.walletRepo.findByProviderId(providerId);
            if (!wallet) {
                wallet = yield this.walletRepo.createWallet(providerId);
            }
