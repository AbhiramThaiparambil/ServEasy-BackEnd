    ...
    execute(data) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                let imgeUrl = "";
                if (serviceNewImg &&
                    !(serviceNewImg === null || serviceNewImg === void 0 ? void 0 : serviceNewImg.includes("https://res.cloudinary.com/"))) {
                ...
                throw new Error(`Error updating service: ${(0, errorUtils_1.getErrorMessage)(error)}`);
            }
        });
    }
};
