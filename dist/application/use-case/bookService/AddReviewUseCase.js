...
let AddReviewUseCase = class AddReviewUseCase {
    constructor(reviewRepository, serviceBookingRepository) {
    ...
    execute(bookedServiceId, serviceId, rating, comment, userId) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield this.serviceBookingRepository.updateReviewId(new mongoose_1.Types.ObjectId(bookedServiceId), review._id);
        });
    }
};
...
exports.AddReviewUseCase = AddReviewUseCase = __decorate([
    ...
    __param(0, (0, tsyringe_1.inject)(ReviewRepository_1.ReviewRepository)),
