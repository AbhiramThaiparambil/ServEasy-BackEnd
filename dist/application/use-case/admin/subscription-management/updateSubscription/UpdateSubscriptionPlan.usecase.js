...
let UpdateSubscriptionPlanUseCase = class UpdateSubscriptionPlanUseCase {
    ...
    execute(id, data) {
        return __awaiter(this, void 0, void 0, function* () {
            var _a;
            const planEntity = Object.assign({}, data);
            const updatedPlan = yield this.subscriptionPlanRepository.updateSubscriptionPlanById(id, planEntity);
            if (!updatedPlan)
                return null;
            return {
                _id: ((_a = updatedPlan._id) === null || _a === void 0 ? void 0 : _a.toString()) || "",
