...
let UserProfileUpdate = class UserProfileUpdate {
    ...
    updateProfile(userId, newUserName, NewProfileImage) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const result = yield this.userRepository.updateUserBasedId(userId, updateData); // Fix 3
            return result;
        });
    }
    sendEmailOtp(email) {
...
exports.UserProfileUpdate = UserProfileUpdate = __decorate([
    (0, tsyringe_1.injectable)(),
    __param(0, (0, tsyringe_1.inject)("CloudinaryService")),
    __param(1, (0, tsyringe_1.inject)("UserRepository")),
    __param(2, (0, tsyringe_1.inject)("EmailOtpService")),
    __param(3, (0, tsyringe_1.inject)(OtpService_1.Otpservice)),
    __param(4, (0, tsyringe_1.inject)("SmsOtpService")),
    __metadata("design:paramtypes", [cloudinary_1.CloudinaryService, Object, mailOtp_1.EmailOtpService,
