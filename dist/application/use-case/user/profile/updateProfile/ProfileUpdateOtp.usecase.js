...
exports.ProfileUpdateOtpUseCase = void 0;
const tsyringe_1 = require("tsyringe");
const tokens_1 = require("../../../../../constants/tokens");
let ProfileUpdateOtpUseCase = class ProfileUpdateOtpUseCase {
    constructor(userRepository, otpService) {
        this.userRepository = userRepository;
        this.otpService = otpService;
    }
    execute(userId, key, enteredOtp) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield this.userRepository.updateUserBasedId(userId, data);
            return {
...
exports.ProfileUpdateOtpUseCase = ProfileUpdateOtpUseCase;
exports.ProfileUpdateOtpUseCase = ProfileUpdateOtpUseCase = __decorate([
