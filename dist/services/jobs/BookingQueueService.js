...
const BullConnection_1 = require("../../infrastructure/jobs/BullConnection");
exports.BOOKING_QUEUE_NAME = 'bookingQueue';
let BookingQueueService = class BookingQueueService {
    constructor(bookingRepository) {
        this.bookingRepository = bookingRepository;
        this.queue = new bullmq_1.Queue(exports.BOOKING_QUEUE_NAME, { connection: BullConnection_1.redisConnection }); // ✅ updated
        this.processJobs();
    }
...
exports.BookingQueueService = BookingQueueService = __decorate([
    ...
    __param(0, (0, tsyringe_1.inject)('ServiceBookingRepository')),
